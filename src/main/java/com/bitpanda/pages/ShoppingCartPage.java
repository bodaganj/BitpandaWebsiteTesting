...
public class ShoppingCartPage extends AbstractPage {
   ...
   private WebElementFacade emptyShoppingCart;

   @FindBy(xpath = ".//*[@id='order-detail-content']")
   private WebElementFacade shoppingCartSummary;

   public ShoppingCartPage(final WebDriver webDriver) {
      super(webDriver);
   }

   public boolean isEmptyShoppingCartElementPresent() {
      return emptyShoppingCart.isPresent();
   }
